...
-- Steam API. You can get a key here, but you should never share it to anyone!: https://steamcommunity.com/dev/apikey

LeadBot.SteamAPIKey = ""
LeadBot.UseFriendsListNames = true
...
-- Names if friends list is not used
